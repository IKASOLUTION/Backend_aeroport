...
public class CompagnieController {
    ...
    @GetMapping("/compagnies/criteria")
    ...
    public ResponseEntity<List<CompagnieDto>> getWithCriteria(final CompagnieDto dto , Pageable pageable) {
        Page<CompagnieDto> page = compagnieService.findByPage(dto,pageable);

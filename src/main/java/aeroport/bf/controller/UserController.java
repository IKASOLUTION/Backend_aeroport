...
import aeroport.bf.dto.PasswordChangeDTO;
import aeroport.bf.dto.TokenRefreshRequest;
...
public class UserController {
    ...
    private ResponseEntity<LoginResponse> login(@Valid @RequestBody final AccountDto accountDto) {
        ...
        log.debug("REST request to login with username : {}", accountDto.getLogin());
        log.debug("REST request to login with password : {}", accountDto.getPassword());
        log.debug("REST request to login with rememberMe : {}", accountDto.getRememberMe());
